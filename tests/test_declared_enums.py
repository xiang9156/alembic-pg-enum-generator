...
class TestGetDeclaredEnums:
    ...
    def test_get_declared_enums_array_column(self):
        ...
        Table(
            ...
            metadata,
            Column('id', Integer, primary_key=True),
            Column('statuses', ARRAY(Enum(TestStatus, name='tag_status', native_enum=True))),
            schema='public'
        )
    ...
    def test_get_declared_enums_different_schema(self):
        ...
        Table(
            ...
            metadata,
            Column('id', Integer, primary_key=True),
            Column('status', Enum(TestStatus, name='user_status', native_enum=True, schema='other_schema')),
            schema='public'
        )
    ...
    def test_get_declared_enums_with_filter(self):
        ...
        Table(
            ...
            Column('id', Integer, primary_key=True),
            Column('status', Enum(TestStatus, name='user_status', native_enum=True)),
            Column('priority', Enum(OrderStatus, name='user_priority', native_enum=True)),
            schema='public'
        )
    ...
    def test_get_declared_enums_non_native_ignored(self):
        ...
        Table(
            ...
            metadata,
            Column('id', Integer, primary_key=True),
            Column('status', Enum(TestStatus, name='user_status', native_enum=False)),  # Not native
            schema='public'
        )
