...
class TestAddEnumValueOp:
    ...
    def test_reverse_not_implemented(self):
        ...
        with pytest.raises(NotImplementedError, match="Enum value removal is not supported"):
            op.reverse()
    ...
    def test_execute_with_special_characters(self):
        ...
        assert 'ALTER TYPE "public"."user_status" ADD VALUE \'pending-review\'' in str(call_args)
    ...
    def test_operation_registration(self, mock_register):
        ...
        assert AddEnumValueOp.__name__ == 'AddEnumValueOp'